import BitCrusher, {
  defaultSettings as bitCrusherDefaultSettings
} from './BitCrusher';
import Compression, {
  defaultSettings as compDefaultSettings
} from './Compression';
import Delay, { defaultSettings as delayDefaultSettings } from './Delay';
import Distortion, {
  defaultSettings as distortionDefaultSettings
} from './Distortion';
import Filter, { defaultSettings as filterDefaultSettings } from './Filter';
import ResonanceFilter, {
  defaultSettings as resFilterDefaultSettings
} from './ResonanceFilter';
