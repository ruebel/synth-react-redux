...
const Refresh = ({height = '24', styleName, width = '24', fill = '#4682b4'}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} className={styleName} viewBox="0 0 48 48">
      <g fill={fill}>
